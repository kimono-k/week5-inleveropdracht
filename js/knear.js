        ...
        if (typeof v[0] == "number") {
          ...
          if (this.array_size > -1) {
            ...
            if (v.length == this.array_size) {
              ...
              console.log(
                `ERROR: learn en classify verwachten een array met numbers van dezelfde lengte, je stuurt nu een array met lengte ${v.length}, terwijl je eerder lengte ${this.array_size} gebruikt hebt.`
              );
            }
          } else {
          ...
          console.log(
            `ERROR: learn en classify verwachten een array met numbers, je stuurt nu array met ${typeof v[0]}.`
          );
        }
      } else {
        console.log(
          "ERROR: learn en classify verwachten een array met numbers, je stuurt nu lege array."
        );
      }
    } else {
      console.log(
        `ERROR: learn en classify verwachten een array met numbers, je stuurt nu geen array, maar ${typeof v}.`
      );
    }
